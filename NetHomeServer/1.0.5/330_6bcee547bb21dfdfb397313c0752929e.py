                        ...
                        if (
                            ...
                            if int(upmHouse) != 10:
                                ...
                                if int(upmDevice) == 3:
                                    ...
                                    if (
                                        rain_Init[1] == 0.0
                                        or rainLevel < rain_Init[0]
                                    ):
                                        rain_Init[0] = rainLevel
                                        start = time.clock()
                                        rain_Init[1] = start

                                    now = time.clock()
                                    
                                    if rainLevel > rain_Init[0]:
                                        diff_level = rainLevel - rain_Init[0]
                                        diff_time = now - rain_Init[1]
                                        rainAverage = diff_level/diff_time # mm/s
