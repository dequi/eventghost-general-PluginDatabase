...
eg.RegisterPlugin(
 ...
 triggered periodically, once only, daily, weekly, monthly or yearly.''',
    ...
    icon = (
        ...
        "ampnZ2fOzs6Pj49mZmYuLi4ICAgAAAAvLy/Pz8+lpaVPT08PDw8QEBCGhoYmJiYAAgAC"
        "HAEIPgMOTQQRVwUTXwYUWwcSVAcMRAQEHQEAAQB/f38gICACKAEKYAMVhgcfpQomswws"
        "vw4wyQ8zyREzxhEwvhAmnA0VbQgFKwKAgICFhYUAEQAERAEPigUbuAklwgsrwQ0uww4y"
        "yA81zRE50xM+2hRD5BZE7hc75BUlqw4NUAWkpKQlJSUADAAFTQIQngUatgggrwoksAso"
        "tQwsug0wwQ8zxhA2yxI60BM91RRC3BZH6BlG9hg0zhMTXQhOTk4AEAAESwEOkgQXqgYb"
        "pQcfqQokrwtA2hVD3xdI6BhN9ho7yxYUXQgCQQEJlQMRogQWngYaowcfqgpC3hdF4xdK"
        "7BlP+Rw30BQOUQZlZWUAJgAFfgILowMQlwQVnQYapAdI5xhN8RtM+xsqrRAGLgOsrKwt"
        "LS0ABAACVgEGnQMKkwMQlQRK7BpR9hxF7Bkabgp9fX0AGwACbQEGmAMKjwMQlgRJ7BpO"
        "8xtU+x0xnhEFHwIANAACfgEGjwNM8BpV+B0/yxcRTAcAOwACggEGjQNT+BxG4RoaYgoA"
        "QAAChgEGjANS+BwebQsARgACiwFK8hofcwtK7RppaWkANQA/zBd8fHwHBwcGlwMxnxEF"
        "IAKrq6sGnAMabwoLogMqrhCOjo4CQgEJlgMRowRP+Bw40RQPUQZNTU0ETAEOkwQVXggB"
        "EQCjo6MQnwU0zxMUXgiEhIQfHx8ERQEPiwUuwg4yxw850hNC5BY75RUmrA4NUQYfpgon"
        "swwswA4wyhAzyhE0yBExwBEnng4VbggFLAICHQEIPwMOTgQSWQYUYAcUXQcTVgcNRgUE"
        "HgIAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABsifhsifgAAtgAAABsighsiggA"
        "AFgAAAAAAAAAAAAAAAAAAAAAAABsX+BsXdgAADQAAABslChsbfgAACQAAABFbowzAAAA"
        "AXRSTlMAQObYZgAAAAlwSFlzAAAuIwAALiMBeKU/dgAAAfpJREFUeNpjYIADRiZmFhBg"
        "ZmJkwASsbOwcnFwQwMnNzsaDJs/Lx8+FDAT4eFHkBYWAgsIiomLiEpJS0jKyQJ6QIJK8"
        "nDxQREFRSVlFVU1dQ1NLWwfIl9eFy+sB5fUNDI2MTUzNzC0sraxtbO30gSpgZtg7cHE5"
        "Ojm7uLq5e3h6efv4+vkHBAY5Am2BuiOYiyskNCw8IjIKqiA6JjYuPgFoBh9Yng3o/sSk"
        "5JTUNJgJ0ekZmVnZOUC/sIEU5HJx5eUXFBYVIysoKS0rr+DiYgfKV1ZxVdfU1tWjKWho"
        "bGrm4uIGhmkLJ1drW3tHJ5qCru6e3j4uTiYGBmYurv4JEzEVTJo8ZSoXFzMDAzsX17Tp"
        "M7AomDlrNhcXC1jBnLnzsCiY37AApmDhIqwKFi8hYMJSuAn43bCMi2s5dl+sgPhi5Spg"
        "OKzGFg5r1oLDYR0oJNdjC8kNslwclbC42IgZF5ugccGwGRibW7ZuQ4vN7Tt2cnHxg2OT"
        "YRcwPe3eg54e9u6DpQeG/eAUdQAlRR08hJSiGA4fAZpx9BgwTR4/YX7S8pT16TNnkdMk"
        "MMqPQFL1ufMXLl66fOXqteugVC2HlO4PO4DyxY2bt27fuXvv/gNhIM9BDyXn7N+FmrP4"
        "g+3RM+fm3KpVsLxZlcuGJfsyrGthZgcB5pZKBhIAAGzq8pEhzc4dAAAAAElFTkSuQmCC"
    ),
)
#===============================================================================
...
class Text:
    ...
    toolTipFolder = "Press button and browse to selected folder ..."
    boxTitle = 'Folder "%s" is incorrect'
    toolTipFile = "Press button and browse to selected logfile ..."
...
class SetEggTimer(eg.ActionBase):
    ...
    class text:
        ...
        fontBtn = "Pop-up font:"
        startBtn = "Start now"
        toolTipFile = "Press button and browse to select a wav file ..."
