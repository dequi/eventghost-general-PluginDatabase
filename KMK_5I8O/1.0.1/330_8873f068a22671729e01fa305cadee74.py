...
# Revision history:
#
# 2009-11-30  Version 1.0.1 (beta)
# 2009-11-10  Version 1.0.0 (beta)
...
class KMK5I8O(eg.PluginClass):
    ...
    def Configure(
      ...
      # Create a combo for board serial
        ...
        board_serialCtrl.AppendItems(strings=list) 
        ...
        mySizer.Add(board_serialCtrl, 1, wx.EXPAND)
        staticBoxSizer.Add(mySizer, 0, wx.EXPAND|wx.ALL, 5)
        ...
        mySizer_1.Add(
            wx.StaticText(panel, -1, self.text.txt_ThreadWaitTime), (1,0)
        )
        ...
        mySizer_2.Add(
            wx.StaticText(panel, -1, self.text.txt_DigitalIn_1), (2,0)
        )
        ...
        mySizer_2.Add(
            wx.StaticText(panel, -1, self.text.txt_DigitalIn_2), (3,0)
        )
        ...
        mySizer_2.Add(
            wx.StaticText(panel, -1, self.text.txt_DigitalIn_3), (4,0)
        )
        ...
        mySizer_2.Add(
            wx.StaticText(panel, -1, self.text.txt_DigitalIn_4), (5,0)
        )
        ...
        mySizer_2.Add(
            wx.StaticText(panel, -1, self.text.txt_DigitalIn_5), (6,0)
        )
        ...
        while panel.Affirmed():
            board_serial = board_serialCtrl.GetStringSelection()
    ...
    def __start__(
        ...
        if majorVersion > 5:
            ...
            if (
                not os.path.exists(progData+'/EventGhost/KMK_5I8O data')
                and not os.path.isdir(progData+'/EventGhost/KMK_5I8O data')
            ):
                os.makedirs(progData+'/EventGhost/KMK_5I8O data')
            else:
                print self.b_nbr, self.text.txt_ReadingData
                try:
                    f = open (
                        progData
                        +'/EventGhost/KMK_5I8O data/KMK_5I8O_p_'
                        +str(self.b_nbr), 'r'
                    )
            ...
            if (
                not os.path.exists('KMK_5I8O data')
                and not os.path.isdir('KMK_5I8O data')
            ):
    ...
    def __stop__(self):
        ...
        if majorVersion > 5:
            ...
            if(
                ...
                os.makedirs(progData+'/EventGhost/KMK_5I8O data')
            print self.b_nbr, self.text.txt_WritingData
            f = open (
                progData
                +'/EventGhost/KMK_5I8O data/KMK_5I8O_p_'
                +str(self.b_nbr), 'w'
