...
class KMK5I8O(eg.PluginClass):
    ...
    def Configure(
      ...
      # Create a combo for board serials
        ...
        di_1_levelCtrl.AppendItems(strings=list) 
        ...
        di_2_levelCtrl.AppendItems(strings=list) 
        ...
        di_3_levelCtrl.AppendItems(strings=list) 
        ...
        di_4_levelCtrl.AppendItems(strings=list) 
        ...
        di_5_levelCtrl.AppendItems(strings=list) 
