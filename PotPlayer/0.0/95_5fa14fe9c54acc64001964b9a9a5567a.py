...
eg.RegisterPlugin(
    ...
    #url = "http://www.eventghost.net/forum/viewtopic.php?t=XXX"
)
#===============================================================================
...
class EventListCtrl(wx.ListCtrl):
    ...
    def __init__(self, parent, id, evtList, ix, plugin):
        ...
        self.il.Add(wx.BitmapFromImage(wx.Image(
...
(eg.ActionGroup, 'GroupMainControls', 'Main controls', None, (
    ...
    (AddFile, "AddFile", "Add file to playlist", "Adds file to playlist.", 0),
    (AddFile, "PlayFile", "Play file", "Immediately plays selected file.", 1),
)),
(eg.ActionGroup, 'JumpTo', 'Jump (to)', None, (
    ...
    ('SpeedNormal', 'Speed normal', None, 21058),
    ('SpeedDown', 'Speed down -', None, 10246),
    ('SpeedUp', 'Speed up +', None, 10247),
