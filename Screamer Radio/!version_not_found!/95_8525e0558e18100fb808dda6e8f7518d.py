            ...
            if play and flag:
                ...
                if len(hwnds) != 0:
                    ...
                    if fav <= self.dh2.counter+1:
                        ...
                        self.PrintError(self.text.over % (str(fav),\
...
class VolumeUp(eg.ActionClass):
    ...
    def __call__(self):       
        ...
        if len(hwnds) != 0:
            ...
            if volume>0:
                PostMessage(hwnds[0], TBM_SETPOS, True, volume-1)
            else:
                volume=1
