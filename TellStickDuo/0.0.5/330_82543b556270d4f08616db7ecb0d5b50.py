...
# Revision history:
#
# 2011-10-17  Added support for sensors
#             Events generated on transmission exceptions
...
class TellStickDuo(eg.PluginClass):
    ...
    def sensorEventCallback(self, protocol, model, id, dataType, value, timestamp, callbackId, context):
        if self.bDeviceEvents:
            ...
            print timestamp
            print callbackId
            print "Sensor:", strProtocol, strModel, "id:", id
            if(dataType == TELLSTICK_TEMPERATURE):
                print "Temperature:", strValue, "C,", datetime.fromtimestamp(timestamp)
            elif(dataType == TELLSTICK_HUMIDITY):
                print "Humidity:", strValue, "%,", datetime.fromtimestamp(timestamp)
