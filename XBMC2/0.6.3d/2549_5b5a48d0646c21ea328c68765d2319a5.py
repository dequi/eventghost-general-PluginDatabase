...
(eg.ActionGroup, "Windows", "Windows", None, (
    ("tv", "tv", "backward compat, same as pvr", "Activatewindow(tv)"),
    ("pvr", "pvr", "", "Activatewindow(pvr)"),
    ("pvrguideinfo", "pvrguideinfo", "", "Activatewindow(pvrguideinfo)"),
    ("pvrrecordinginfo", "pvrrecordinginfo", "", "Activatewindow(pvrrecordinginfo)"),
    ("pvrtimersetting", "pvrtimersetting", "", "Activatewindow(pvrtimersetting)"),
    ("pvrgroupmanager", "pvrgroupmanager", "", "Activatewindow(pvrgroupmanager)"),
    ("pvrchannelmanager", "pvrchannelmanager", "", "Activatewindow(pvrchannelmanager)"),
    ("pvrguidesearch", "pvrguidesearch", "", "Activatewindow(pvrguidesearch)"),
    ("pvrchannelscan", "pvrchannelscan", "", "Activatewindow(pvrchannelscan)"),
    ("pvrupdateprogress", "pvrupdateprogress", "", "Activatewindow(pvrupdateprogress)"),
    ("pvrosdchannels", "pvrosdchannels", "", "Activatewindow(pvrosdchannels)"),
    ("pvrosdguide", "pvrosdguide", "", "Activatewindow(pvrosdguide)"),
    ("pvrosddirector", "pvrosddirector", "", "Activatewindow(pvrosddirector)"),
    ("pvrosdcutter", "pvrosdcutter", "", "Activatewindow(pvrosdcutter)"),
    ("pvrosdteletext", "pvrosdteletext", "", "Activatewindow(pvrosdteletext)"),
    ("filemanager", "filemanager", "", "Activatewindow(filemanager)"),
    ("videos", "videos", "", "Activatewindow(videos)"),
...
(eg.ActionGroup, "Remote", "Remote", None, (
    ...
    ('RemoteLiveradio', 'LiveRadio', '', 'liveradio'),
    ('RemoteEpgsearch', 'EPGSearch', '', 'epgsearch'),
)),
)
