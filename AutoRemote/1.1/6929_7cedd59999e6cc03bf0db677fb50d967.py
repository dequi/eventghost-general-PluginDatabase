...
class RegisterEventGhost(eg.ActionBase):
    ...
    def __call__(self,  name="", url="",key="", defaultchannel=""):
        ...
        print(localip + ":" + port)
        urllib.urlopen('http://autoremotejoaomgcd.appspot.com/registerpc?id={0}&name={0}&localip={1}:{2}&publicip={5}:{2}&channel={3}&key={4}'.format(self.plugin.name, localip, port, defaultchannel, key, publicIp))
