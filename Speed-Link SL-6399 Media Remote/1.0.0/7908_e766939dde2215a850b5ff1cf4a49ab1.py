...
# 2012/12: Added codes for all missing remote keys + mouse keys, Moti Radomski <moti.radomski@gmail.com>
#
...
class Speedlink(eg.PluginBase):
    ...
    def Callback2(self, data):
        ...
        if code in CODES2:
          ...
          code = data[:4]
          if code in CODES_MOUSE:
            self.TriggerEnduringEvent(CODES_MOUSE[code])
          else:
              print "#2", data
