...
eg.RegisterPlugin(
    name = "BSPlayer",
    author = "CHeitkamp",
    version = "1.0." + "$LastChangedRevision: 1431 $".split()[1],
    kind = "program",
...
ACTIONS = (
    ( eg.ActionGroup, 'GroupMainControls', 'Main controls', None, (
        ...
        ( 'BSP_ExitFScreen', 'Exit FullScreen Mode', None, BSP_ExitFScreen),
        ( 'BSP_GetFileName', 'Get File Name', None, BSP_GetFileName),
        ( 'BSP_OpenFile', 'Open File', None, BSP_OpenFile),
        ( 'BSP_GetVol', 'Get Volume', None, BSP_GetVol),
        ( 'BSP_GetStatus', 'Get Status', None, BSP_GetStatus),
        ( 'BSP_GetMovPos', 'Get Movie Posistion', None, BSP_GetMovPos),
        ( 'BSP_GetMovLen', 'Get Movie Length', None, BSP_GetMovLen),
        ( 'BSP_OpenURL', 'Open URL', None, BSP_OpenURL),
        ( 'BSP_MovSubDown', 'Movie Subtitels Down', None, BSP_MovSubDown),
        ( 'BSP_MovSubUp', 'Movie Subtitels Up', None, BSP_MovSubUp),
        ( 'BSP_MoveLeft', 'MoveLeft', None, BSP_MoveLeft),
        ( 'BSP_MoveRight', 'MoveRight', None, BSP_MoveRight),
        ( 'BSP_MoveUp', 'MoveUp', None, BSP_MoveUp),
        ( 'BSP_MoveDown', 'MoveDown', None, BSP_MoveDown),
