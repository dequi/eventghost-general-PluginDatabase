...
class RFXcom(eg.PluginClass):
    ...
    def __init__(self):
        ...
        self.hostname="rfxcom-eg."+str(gethostname())[:8].lower()
                ...
                if msgschema <> "hbeat.app" :
                    if xplsource == self.xplDeviceName:
                        if message <> messageOld:
                            ...
                            # New test having sensor data in the payload
                            ml = msgbody2.split(',')
                            msgbody3 = ml[0]+','+ml[1]
                            msgbody4 = ''
                            ml = ml[2:len(ml)-1]
    ...
    def Configure(
        ...
        *args
        ...
        while panel.Affirmed():
            ...
            xplNamePart1 = xplDeviceName.split('-')[0]
            xplNamePart2 = xplDeviceName.split('-')[1].split('.')[0]
            xplNamePart3 = xplDeviceName.split('-')[1].split('.')[1]
            if len(xplNamePart1)>8:
                xplNamePart1 = xplNamePart1[:8]
            if len(xplNamePart2)>8:
                xplNamePart2 = xplNamePart2[:8]
            if len(xplNamePart3)>16:
                xplNamePart3 = xplNamePart3[:16]
            xplDeviceName = xplNamePart1+'-'+xplNamePart2+'.'+xplNamePart3     
...
#            time.sleep(1.0)
    ...
    def Configure(
        ...
        delayCtrl.AppendItems(strings=list) 
