...
BUTTON_CODES = {
	(2, 178, 0, 0, 0, 0, 0, 0): 'Record',
	(2, 177, 0, 0, 0, 0, 0, 0): 'Pause',
	(2, 183, 0, 0, 0, 0, 0, 0): 'Stop',
	(2, 180, 0, 0, 0, 0, 0, 0): 'Rewind',
	(2, 176, 0, 0, 0, 0, 0, 0): 'Play',
	(2, 179, 0, 0, 0, 0, 0, 0): 'FFwd',
	(2, 182, 0, 0, 0, 0, 0, 0): 'Skip <',
	(2, 181, 0, 0, 0, 0, 0, 0): 'Skip >',
	(2, 36, 2, 0, 0, 0, 0, 0): 'Back',
	(2, 9, 2, 0, 0, 0, 0, 0): 'Info',
	(2, 233, 0, 0, 0, 0, 0, 0): 'Vol+',
	(2, 234, 0, 0, 0, 0, 0, 0): 'Vol-',
	(2, 226, 0, 0, 0, 0, 0, 0): 'Mute',
	(2, 156, 0, 0, 0, 0, 0, 0): 'Ch +',
	(2, 157, 0, 0, 0, 0, 0, 0): 'Ch -',
	(2, 141, 0, 0, 0, 0, 0, 0): 'Guide',
	(3, 13, 0, 0, 0, 0, 0, 0): 'MCE',
	(3, 72, 0, 0, 0, 0, 0, 0): 'Rec TV',
	(3, 37, 0, 0, 0, 0, 0, 0): 'Live TV',
	(3, 36, 0, 0, 0, 0, 0, 0): 'DVD Menu',
	(3, 71, 0, 0, 0, 0, 0, 0): 'Music',
	(3, 73, 0, 0, 0, 0, 0, 0): 'Pics',
	(3, 74, 0, 0, 0, 0, 0, 0): 'Video',
	(3, 80, 0, 0, 0, 0, 0, 0): 'Radio',
	(3, 90, 0, 0, 0, 0, 0, 0): 'Teletext',
	(3, 91, 0, 0, 0, 0, 0, 0): 'Red',
	(3, 92, 0, 0, 0, 0, 0, 0): 'Green',
	(3, 93, 0, 0, 0, 0, 0, 0): 'Yellow',
	(3, 94, 0, 0, 0, 0, 0, 0): 'Blue',
    (1, 2, 0, 0, 0, 0, 0, 0): 'Power',
}
...
class Emprex(eg.PluginBase):
    ...
    def ButtonsCallback(self, data):
        if data == (2, 0, 0, 0, 0, 0, 0, 0) or data == (3, 0, 0, 0, 0, 0, 0, 0) or data == (1, 0, 0, 0, 0, 0, 0, 0):
            self.EndLastEvent()
        else:
