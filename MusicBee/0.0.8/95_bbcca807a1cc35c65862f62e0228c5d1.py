...
class Text:
    ...
    fileMask = "MusicBee executable|MusicBee.exe|All-Files (*.*)|*.*"
    running = "Running"
...
Commands = (
    ...
    (Group.Player,0,67), #Toggle repeat
...
class MusicBee(eg.PluginBase):
    ...
    def mbPluginStartup(self, suff):
        self.TriggerEvent(suff)
    ...
    def Handler(self, hwnd, mesg, wParam, lParam):
        ...
        if cmd == CMD_CONNECT:
            ...
            eg.scheduler.AddTask(3, self.mbPluginStartup, msg[0])
