eg.RegisterPlugin(
    name = "SageTV",
    author = "Bitmonster",
    version = "1.2." + "$LastChangedRevision: 418 $".split()[1],
    kind = "program",
...
FindSageClient = eg.WindowMatcher(u'SageClientApp',u'SageWin', None, None, None, 1, False, 0.0, 0)
FindSageApp = eg.WindowMatcher(u'SageApp',u'SageWin', None, None, None, 1, False, 0.0, 0)
...
class SageTV(eg.PluginClass):
    ...
    def __start__(self, useClient=False):
        if useClient:
            ...
            self.windowMatch = FindSageClient
        else:
            self.targetClass = "SageApp"
            self.windowMatch = FindSageApp
