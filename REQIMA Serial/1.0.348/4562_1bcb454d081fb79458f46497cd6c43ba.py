...
# REQIMA8Serial V1.0
# ================
# Written by Rob Still, <robert.still.c@gmail.com>
# Public Domain
#
#
# Revision history:
...
help = """\
Small trivial plugin to control Request IMA6 multi-source / multi-zone amplifier via RS-232.


Replies from the IMA8 are turned into events. Description of
commands and their replies can be found in the document
"REQ88_software_012410.pdf", which is available from the ILBA America
websites. 
...
('PowerToggle', 'Power Toggle On/Off', '\x52\x45\x51\x38\x38\x43\x00\x20\x31\x20\x20\x20\x20\FF', None),
('PowerOff', 'Power Off', '\x52\x45\x51\x38\x38\x43\x00\x20\x32\x20\x20\x20\x20\FF', None),
('PowerOff', 'Power Off', '\x52\x45\x51\x38\x38\x43\x00\x20\x32\x20\x20\x20\x20\FF', None),


#Zone 1 Source Selection Commands

('Zone1Source1', 'Set Zone 1 to Source 1', '\x52\x45\x51\x38\x38\x43\x00\x00\x33\x00\x20\x20\x20\FF', None),CM4 52h 45h 51h 38h 38h 43h A B 33h F P 20h 20h FFh
...
class Raw(eg.ActionWithStringParameter):
    ...
    def __call__(self, data):
        self.plugin.serial.write(str(data) + chr(0xff))
#        self.plugin.serial.write(str(data) + chr(13))

    
        
        
class REQIMASerial(eg.PluginClass):
