...
class HIDThread(threading.Thread):
    def __init__(self,
        ...
        self.xbcdrc_mapping = {
            '006d50a': 'DISPLAY', '0066a05': 'DISPLAY', '0066afd': 'DISPLAY','006d502': 'DISPLAY',
            '006e202': 'REVERSE', '00671f5': 'REVERSE', '006710d': 'REVERSE',
            '006ea02': 'PLAY', '00675f5': 'PLAY', '006750d': 'PLAY',
            'fffffff': 'FORWARD', '0067105': 'FORWARD', '00671fd': 'FORWARD',
            '006e202': 'SKIP-', '0066e05': 'SKIP-', '0066efd': 'SKIP-',
            '006e002': 'STOP', '00670f5': 'STOP', '006700d': 'STOP',
            '006e602': 'PAUSE', '00673f5': 'PAUSE', '006730d': 'PAUSE',
            '006e302': 'SKIP+', '0066f05': 'SKIP+', '0066ffd': 'SKIP+',
            'fffffff': 'TITLE', '0067205': 'TITLE', '00672fd': 'TITLE',
            '006c302': 'INFO', '0066105': 'INFO', '00661fd': 'INFO',
            '006a602': 'UP', '00653f5': 'UP', '006530d': 'UP',
            '006a702': 'DOWN', '0065305': 'DOWN', '00653fd': 'DOWN',
            '006a902': 'LEFT', '0065405': 'LEFT', '00654fd': 'LEFT',
            '006a802': 'RIGHT', '00654f5': 'RIGHT', '006540d': 'RIGHT',
            '0060b02': 'SELECT', '0060b02': 'SELECT', '00605fd': 'SELECT',
            '006f702': 'MENU', '0067b05': 'MENU', '0067bfd': 'MENU',
            '006d802': 'BACK', '0066cf5': 'BACK', '0066c0d': 'BACK',
            '006ce02': '1', '00667f5': '1', '006670d': '1',
            '006cd02': '2', '0066605': '2', '00666fd': '2',
            '006cc02': '3', '00666f5': '3', '006660d': '3',
            '006cb02': '4', '0066505': '4', '00665fd': '4',
            '006ca02': '5', '00665f5': '5', '006650d': '5',
            '006c902': '6', '0066405': '6', '00664fd': '6',
            '006c802': '7', '00664f5': '7', '006640d': '7',
            '006c702': '8', '0066305': '8', '00663fd': '8',
            '006c602': '9', '00663f5': '9', '006630d': '9',
            '006cf02': '0', '0066705': '0', '00667fd': '0',
#            'fffffff': 'AUDIO',
#            'fffffff': 'ENT.',
#            'fffffff': 'LT',
#            'fffffff': 'LAST',
...
#                self.xbcdrc_mapping[str(code)]=str(prefix+'_'+event)
            ...
            if len(buf) == n and not self.abort:
                ...
                if mystr[0] == "0":
                    ...
                    try:
                        ...
                        self.plugin.TriggerEvent('UNKNOWN',mystr)
                        continue
					#if mystr == old_event:
                    #    continue
                    #old_event = mystr
