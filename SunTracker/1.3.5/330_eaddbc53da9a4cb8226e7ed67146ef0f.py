...
#            remain = 10
            ...
            if initsynch == 1:
                ...
                if(
                    ...
                    print(
                    "Moving Ghost...enabled for " 
                    +self.name
                    +"...ends standard operation"
                    )
            ...
            if(
                ...
                if initsynch != 1:
                    print(
                    "Moving Ghost...disabled for " 
                    +self.name
                    +"...starts standard operation"
                    )
                    initsynch = 1
...
class Suntracker(eg.PluginClass):
    ...
    def CheckWeatherCondition(self):
        ...
        if (
            not weather_data.has_key('current_conditions')
            or
            not weather_data['current_conditions'].has_key('condition')
        ):
    ...
    def main(self,mainThreadEvent):
        ...
        while not mainThreadEvent.isSet():
            ...
            diff = datetime.timedelta(
                minutes=int(strTz[0]) * 60 + int(strTz[1]) + iDLS * 60
            )
            corr = now + diff
            hr = str(corr.hour)
            mn = str(corr.minute)
