...
#             stability
# 2012-08-04  Re-worked the dawn/dusk calcutation action with start and stop
...
# 2012-07-30  Added a getter action to check dawn/dusk calcutations for
...
class GetSunStatusWeatherCompensated(eg.ActionClass):
    ...
    def __call__(
        ...
        if not self.plugin.initsynch:
            ...
            print currCondition, timeCompensation
            print trigTimeSS, self.plugin.csSS
            print trigTimeSR, self.plugin.csSR
...
#                'twilight start type: '+ tlStartType,
#                'twilight end type: '+ tlEndType
#            )
#            print (
#                'Virtual Start: '+ virtualStart,
#                'Virtual End: '+ virtualEnd,
#                'Is inside range? '+ str(isInsideRange)
#            )
#            print (
#                'Stops macro if true? '+ str(stopMacroOnTrue),
#                'Stops macro if false? '+ str(stopMacroOnFalse)
#            )
