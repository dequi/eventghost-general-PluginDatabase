...
###
### changelog:
### v0.7.6      - Hack by Radengr to make it work with remote lirc clients
### 2011-12-11  - where certain responces are split into multiple events.
###             - Instead of issuing a malformedresponse warning I just save
###             - in these cases and stick it on the front of the next event.
###
###
        ...
        for self.event in self.events:
            ...
            if self.event == "BEGIN":
               ...
               try:
                  ...
                  self.receivedresponse = 1
                  # if we think this is a partial response, save instead of issuing warning
                  if self.event == "BEGIN":
