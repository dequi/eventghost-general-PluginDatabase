...
HOUSE_UNITS = {
    ...
    '48': 'D1', '49': 'D2', '50': 'D3', '51': 'D4', '52': 'D5', '53': 'D6',
    '54': 'D7', '55': 'D8', '56': 'D9', '57': 'D10', '58': 'D11',
    '59': 'D12', '60': 'D13', '61': 'D14', '62': 'D15', '63': 'D16',

    '64': 'E1', '65': 'E2', '66': 'E3', '67': 'E4', '68': 'E5', '69': 'E6',
    '70': 'E7', '71': 'E8', '72': 'E9', '73': 'E10', '74': 'E11',
    '75': 'E12', '76': 'E13', '77': 'E14', '78': 'E15', '79': 'E16',
    
    '80': 'F1', '81': 'F2', '82': 'F3', '83': 'F4', '84': 'F5', '85': 'F6',
    '86': 'F7', '87': 'F8', '88': 'F9', '89': 'F10', '90': 'F11',
    '91': 'F12', '92': 'F13', '93': 'F14', '94': 'F15', '95': 'F16',

    '96': 'G1', '97': 'G2', '98': 'G3', '99': 'G4', '100': 'G5', '101': 'G6',
    '102': 'G7', '103': 'G8', '104': 'G9', '105': 'G10', '106': 'G11',
    '107': 'G12', '108': 'G13', '109': 'G14', '110': 'G15', '111': 'G16',
    
    '112': 'H1', '113': 'H2', '114': 'H3', '115': 'H4', '116': 'H5', '117': 'H6',
    '118': 'H7', '119': 'H8', '120': 'H9', '121': 'H10', '122': 'H11',
    '123': 'H12', '124': 'H13', '125': 'H14', '126': 'H15', '127': 'H16',

    '128': 'I1', '129': 'I2', '130': 'I3', '131': 'I4', '132': 'I5', '133': 'I6',
    '134': 'I7', '135': 'I8', '136': 'I9', '137': 'I10', '138': 'I11',
    '139': 'I12', '140': 'I13', '141': 'I14', '142': 'I15', '143': 'I16',
    
    '144': 'J1', '145': 'J2', '146': 'J3', '147': 'J4', '148': 'J5', '149': 'J6',
    '150': 'J7', '151': 'J8', '152': 'J9', '153': 'J10', '154': 'J11',
    '155': 'J12', '156': 'J13', '157': 'J14', '158': 'J15', '159': 'J16',

    '160': 'K1', '161': 'K2', '162': 'K3', '163': 'K4', '164': 'K5', '165': 'K6',
    '166': 'K7', '167': 'K8', '168': 'K9', '169': 'K10', '170': 'K11',
    '171': 'K12', '172': 'K13', '173': 'K14', '174': 'K15', '175': 'K16',

    '176': 'L1', '177': 'L2', '178': 'L3', '179': 'L4', '180': 'L5', '181': 'L6',
    '182': 'L7', '183': 'L8', '184': 'L9', '185': 'L10', '186': 'L11',
    '187': 'L12', '188': 'L13', '189': 'L14', '190': 'L15', '191': 'L16',
    
    '192': 'M1', '193': 'M2', '194': 'M3', '195': 'M4', '196': 'M5', '197': 'M6',
    '198': 'M7', '199': 'M8', '200': 'M9', '201': 'M10', '202': 'M11',
    '203': 'M12', '204': 'M13', '205': 'M14', '206': 'M15', '207': 'M16',

    '208': 'N1', '209': 'N2', '210': 'N3', '211': 'N4', '212': 'N5', '213': 'N6',
    '214': 'N7', '215': 'N8', '216': 'N9', '217': 'N10', '218': 'N11',
    '219': 'N12', '220': 'N13', '221': 'N14', '222': 'N15', '223': 'N16',
    
    '224': 'O1', '225': 'O2', '226': 'O3', '227': 'O4', '228': 'O5', '229': 'O6',
    '230': 'O7', '231': 'O8', '232': 'O9', '233': 'O10', '234': 'O11',
    '235': 'O12', '236': 'O13', '237': 'O14', '238': 'O15', '239': 'O16',

    '240': 'P1', '241': 'P2', '242': 'P3', '243': 'P4', '244': 'P5', '245': 'P6',
    '246': 'P7', '247': 'P8', '248': 'P9', '249': 'P10', '250': 'P11',
    '251': 'P12', '252': 'P13', '253': 'P14', '254': 'P15', '255': 'P16'            
}
...
class X10Events:
    ...
    def OnX10Command(
        ...
        if eKeyState == 1:
            plugin.TriggerEnduringEvent("%s.%s" % (plugin.mappingTable.get(event, event), house_unit))
        elif eKeyState == 2:
            plugin.EndLastEvent()
