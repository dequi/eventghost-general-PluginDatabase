...
eg.RegisterPlugin(
    ...
    description = (
            ...
            '     <li>RecordingStop</li>'
            '     <li>NowPlaying</li>'
            '<br>Extended Events:<br>'
            '<UL> <li>NowPlaying.Play</li>'
            '     <li>NowPlaying.Paused</li>'
            '     <li>NowPlaying.Stopped</li></ul>'
            '</ul>'
            '<br><br>'
            'note: '
            'requires the '
            '<a href="http://tools.assembla.com/sageplugins/wiki/GetStatusPlugin#preview">'
            'GetStatus</a> plugin for SageTV.'
        ),
    icon = (
