...
class GetNotAccessibleTracks(eg.ActionBase):
    u'''<rst>**Show/Edit tracks that MediaMonkey cannot access.**
...
'''
    ...
    def Configure(
        ...
        mySizer.Add(clearPlaylistChkBoxCtrl,(4,1),(1,1),flag=wx.RIGHT)
