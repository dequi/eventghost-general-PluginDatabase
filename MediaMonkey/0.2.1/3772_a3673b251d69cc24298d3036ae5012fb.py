...
results of the query (i.e. number of tracks found will be stored in {eg.result}). Choose whether
...
Advantage: (True Shuffle)  Shuffles the playlist (like cards) before starting playback "%s"
whereas selecting the Shuffle checkbox will cause the player to jump randomly through a playlist.
...
class GetStatus(eg.ActionBase):
    ...
    def __call__(self):
        ...
        if not playing:
            return "Stoped"
#note by James: I didn't want to edit the actual code but stopped is spelled wrong here...missing a 'p'
