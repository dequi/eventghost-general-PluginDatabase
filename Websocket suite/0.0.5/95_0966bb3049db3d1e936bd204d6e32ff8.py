...
# -------------------------------------------
# 0.0.5 by Krambriw 2012-01-14
#     - fixed bug with empty Persistent variables (credit to kingtd for solving this)
#     - added some more debug-logging to better tracing
