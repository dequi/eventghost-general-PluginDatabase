...
class Text:
    ...
    Grp1Descr = "Here you find actions for basic control of iTunes."
    Grp2Name = "More control of iTunes"
    Grp2Descr = (
...
class iTunesThreadWorker(eg.ThreadWorker):
    ...
    def GetProperty(self,name):
        ...
        try:
            ...
            eg.PrintError("hmhm invalid iTunes property (%s)"%name)
...
(ToggleAction, 'Zoom', 'Toggle Fullscreen', 'Switch in or out of Fullscreen mode', 'FullScreenVisuals'),
